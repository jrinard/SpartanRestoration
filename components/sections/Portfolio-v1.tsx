...
export function PortfolioV1({
  ...
  const displayHeading = preview?.settings.heading || heading;
  const displayProjects =
    preview?.settings.projects && preview.settings.projects.length > 0
      ? preview.settings.projects
      : projects;
  const displayBranding =
    preview?.settings.brandingProjects && preview.settings.brandingProjects.length > 0
      ? preview.settings.brandingProjects
      : brandingProjects;
  ...
  const hasBranding = displayBranding.length > 0;
  const activeProjects = activeTab === "branding" ? displayBranding : displayProjects;
