...
/**
 * Bottom footer bar — copyright + social icons.
 */
export function FooterBar({ socialLinks = defaultSocialLinks }: FooterBarProps) {
...
/**
 * Full footer with link columns + bottom bar with social icons.
 */
export function FooterV2({ description }: FooterV2Props) {
  return (
    <footer>
