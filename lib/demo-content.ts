...
/**
 * Add-section defaults only. Image URLs follow the open org:
 * `orgs/<id>/assets/images/…` served as `/org-assets/<id>/images/…`.
 * LSD production copy is data in `orgs/lsd/` (seeded from `lsd*` exports). Getters below
 * are never org-gated — painting LSD words from here is a bug.
 */
export function orgAsset(relative: string): string {
  const folder = siteConfig.assets.themeFolder || "lsd";
  return `/org-assets/${folder}/images/${relative.replace(/^\/+/, "")}`;
}

/** Frozen LSD production paths — used to seed `orgs/lsd/` copy, never the open org. */
export function lsdImage(relative: string): string {
  return `/org-assets/lsd/images/${relative.replace(/^\/+/, "")}`;
}

/** True while the open org’s asset folder is `lsd`. */
export function isLsdOrg(): boolean {
  return (siteConfig.assets.themeFolder || "lsd") === "lsd";
}

export const lsdHeroDemoCopy = {
...
export const heroDemo = {
  ...
  lines: ["Your", "Headline", "Here"],
  subtext: "Add a short supporting line for this organization.",
  ctaLabel: "Let's Talk",
  ctaHref: "/contact",
};

export const lsdHeroV21Copy = {
...
export const sandboxHeroV21Demo = {
  headlineLines: ["Your headline", "Goes here"],
  subtextLines: [
    "Replace this with a short line about this organization.",
    "Add more lines if you want the subtext to rotate.",
  ],
  ctaLabel: "Let's Talk",
  ctaHref: "/contact",
  highlights: [
    {
      ...
      description: "Describe a service or offer for this organization.",
      href: "#services",
    },
    {
      title: "Second highlight",
      description: "A second card so the layout matches a live hero.",
    },
  ],
};

export const heroV21Demo = sandboxHeroV21Demo;

export const lsdProjects = [
  {
    ...
    imageSrc: lsdImage("portfolio-sites/ospower-example.png"),
    imageAlt:
  ...
  },
  {
    ...
    imageSrc: lsdImage("rvbx-example-desktop.png"),
  ...
  },
  {
    ...
    imageSrc: lsdImage("portfolio-sites/gfp-example.png"),
  ...
  },
  {
    ...
    imageSrc: lsdImage("portfolio-sites/port-crm-example.jpg"),
    imageAlt:
  ...
  },
  {
    ...
    imageSrc: lsdImage("portfolio-sites/port-zoe-example.png"),
  ...
  },
  {
    ...
    imageSrc: lsdImage("portfolio-sites/port-mom-example.jpg"),
  ...
  },
  {
    ...
    imageSrc: lsdImage("portfolio-sites/port-closet-example.jpg"),
  ...
  },
  {
    ...
    imageSrc: lsdImage("portfolio-sites/port-bli-example.jpg"),
  ...
  },
  {
    ...
    imageSrc: lsdImage("portfolio-sites/port-stoken-example.jpg"),
    imageAlt: "Stoken Joe Coffee website and branding designed by LifeSpring Design",
  },
  {
    title: "Orpheum Theater",
    tags: "Website Design, Branding",
    imageSrc: lsdImage("portfolio-sites/port-orph-example.png"),
...
const sandboxProjects = [
  {
    ...
    get imageSrc() {
      return orgAsset("portfolio-sites/ospower-example.png");
    },
...
const sandboxFeatureTiles = [
  {
    title: "Projects",
    subtext: "Browse work for this organization.",
    href: "/portfolio",
    imageAlt: "Projects",
  },
  {
    title: "Services",
    subtext: "Describe what this organization offers.",
    href: "/our-services",
    imageAlt: "Services",
  },
];

export function getFeatureTiles() {
  return sandboxFeatureTiles;
}

const lsdTestimonials = [
  {
    quote:
...
const sandboxTestimonials = [
  {
    quote: "Replace this with a customer quote for this organization.",
    name: "Customer name",
    role: "Role · City",
  },
];
...
export function getTestimonials() {
  return sandboxTestimonials;
}

export const lsdSimpleServices = [
  {
    ...
    icon: lsdImage("demo-website-design.png"),
  ...
  },
  {
    ...
    icon: lsdImage("demo-custom-soft.png"),
  ...
  },
  {
    ...
    icon: lsdImage("Reviewbox-logo.png"),
  ...
  },
  {
    ...
    icon: lsdImage("demo-icon-dia-green.png"),
...
const sandboxSimpleServices = [
  {
    title: "Service one",
    description: "Describe a service this organization offers.",
    get icon() { return orgAsset("demo-website-design.png"); },
  ...
  },
  {
    ...
    get icon() { return orgAsset("demo-custom-soft.png"); },
    iconAlt: "Service icon",
    bullets: ["Benefit one", "Benefit two", "Benefit three"],
  },
];
...
export function getSimpleServices() {
  return sandboxSimpleServices;
}

export const lsdServicesV1Cta = {
  headline: "Great businesses need a trusted developer.",
  text: "We can help you.",
  ctaLabel: "Serving Clark County",
  ctaHref: SERVICE_AREAS_PATH,
};

export const servicesV1Cta = {
  headline: "Ready to talk about this project?",
  text: "Replace this with a short call to action.",
  ctaLabel: "Let's Go",
...
const sandboxPartnerLogos = ["Partner one", "Partner two", "Partner three"];

export function getPartnerLogos() {
  return sandboxPartnerLogos;
}

export const lsdCtaContent = {
  headlineLines: ["Ready to grow your business?", "Let's talk about what you are building."],
};

export const ctaContent = {
  headlineLines: ["Ready to grow?", "Let's talk about this organization."],
  get phoneLabel() {
    return siteConfig.phone;
  },
  get phoneHref() {
    return phoneTelHref(siteConfig.phone);
  },
};
...
export const lsdReviewboxCopy = {
  logoSrc: lsdImage("Reviewbox-logo.png"),
...
export const reviewboxContent = {
  ...
  ctaHref: "https://reviewbox.io",
  desktop: {
    get imageSrc() { return orgAsset("rvbx-example-desktop.png"); },
    imageAlt: "Reviewbox.io review management dashboard on desktop",
  },
  leftExample: {
    get imageSrc() { return orgAsset("rvbx-os-example.png"); },
    imageAlt: "Reviewbox.io review request widget on a local business website",
  },
  rightMessage: {
    get imageSrc() { return orgAsset("rvbx-example-message-send.png"); },
    imageAlt: "Reviewbox.io SMS review request message on a mobile phone",
  },
};
...
export function getServicesIconsSubheading() {
  return `${siteConfig.name} offers design, development, and marketing support under one roof. Tell us what you need—we will help you get there.`;
}

export const servicesIconsV2Heading = "Our Services";

export function getServicesIconsV2SeoDescription() {
  return `${siteConfig.name} offers cabinetry, carpentry, concrete, demolition, doors, drywall, fencing, gutters, painting, junk removal, patio enclosures, power washing, snow removal, and window services.`;
}
...
export const servicesIconsV2Services: ReadonlyArray<{
...
}> = [
  {
    ...
    title: "Cabinetry",
    icon: "layout-grid",
    description: "Custom cabinet design, installation, and refinishing.",
  },
  {
    id: "carpentry",
    title: "Carpentry",
    icon: "hammer",
    description: "Framing, trim work, and finish carpentry for your project.",
  },
  {
    id: "concrete-projects",
    title: "Concrete Projects",
    icon: "brick-wall",
    description: "Concrete pads, walkways, repairs, and flatwork.",
  },
  {
    id: "demolition",
    title: "Demolition",
    icon: "axe",
    description: "Selective demolition and safe tear-out for remodels.",
  },
  {
    id: "doors-hardware",
    title: "Doors / Door hardware",
    icon: "door-open",
    description: "Door installation, adjustment, and hardware upgrades.",
  },
  {
    id: "drywall",
    title: "Drywall",
    icon: "layers",
    description: "Drywall hang, finish, texture, and patch repair.",
  },
  {
    id: "fencing",
    title: "Fencing",
    icon: "fence",
    description: "Fence installation, repair, and gate work.",
  },
  {
    id: "gutters",
    title: "Gutters",
    icon: "cloud-rain",
    description: "Gutter installation, cleaning, and downspout repair.",
  },
  {
    id: "interior-painting",
    title: "Interior Painting",
    icon: "brush",
    description: "Interior painting, prep, and clean professional finishes.",
  },
  {
    id: "junk-removal",
    title: "Junk Removal",
    icon: "trash-2",
    description: "Fast junk removal and haul-away for homes and job sites.",
  },
  {
    id: "patio-enclosures",
    title: "Patio Enclosures",
    icon: "home",
    description: "Patio enclosures and covered outdoor living spaces.",
  },
  {
    id: "power-washing",
    title: "Power washing",
    icon: "spray-can",
    description: "Power washing for siding, decks, driveways, and more.",
  },
  {
    id: "snow-removal",
    title: "Snow Removal",
    icon: "snowflake",
    description: "Seasonal snow removal and ice management.",
  },
  {
    id: "windows",
    title: "Windows",
    icon: "panel-top",
    description: "Window replacement, repair, and weather sealing.",
  },
];
...
/** Playground-only lorem cards — never shown on /preview or live. */
export const reviewsV1PlaceholderReviews: GoogleReview[] = [
  {
...
export const washingHero = {
  ...
  quoteHref: "/contact",
  get phoneLabel() {
    return siteConfig.phone || "503-555-0100";
  },
  get phoneHref() {
    return `tel:${(siteConfig.phone || "5035550100").replace(/\D/g, "")}`;
  },
...
/** Stone Pillar Contractors — Text-icons v3 "Why Choose Us" block. */
export const stonePillarTextIconsContent = {
  heading: "Why Choose Stone Pillar Contractors?",
  subheading:
    "Quality and inspiration drive everything we do. We never compromise on craftsmanship, even when a project needs more time, and we work to put lasting value back into your home. From cabinetry and carpentry to concrete and complete renovations, we educate our clients and serve as good stewards through every phase of the job.",
  items: [
    {
      id: "why-quality",
      icon: "sparkles",
      ...
      description:
        "We hold every project to the highest standards of craftsmanship. No shortcuts, no cut corners, just careful work built to last, even when it means more time on the job.",
    },
    {
      id: "why-value",
      icon: "home",
      title: "Value Back Into Your Home",
      description:
        "Our goal is superiority in every detail, with work that improves your property, stands the test of time, and delivers real value long after we leave.",
    },
    {
      id: "why-partnership",
      icon: "hard-hat",
      ...
      description:
        "We guide you from planning through implementation and closure, keeping you informed, answering questions honestly, and measuring success by your satisfaction.",
    },
  ] as ReadonlyArray<{
    id: string;
    icon: SiteIconName;
...
function stonePillarPhone(): string {
  return siteConfig.teamContacts[0]?.phone ?? siteConfig.phone;
}

/** Stone Pillar Contractors — Text and Images v1 (commercial / residential / restoration rows). */
export const stonePillarTextImagesContent = {
  row1: {
    eyebrow: "Stone Pillar Contractors.",
    headlineLines: ["Built on Integrity,", "Strong in Every Detail"],
    body:
      "Stone Pillar Contractors is a locally trusted general contractor serving Vancouver, Portland, and the Pacific Northwest. We bring clear communication, steady leadership, and hands-on craftsmanship to commercial, residential, and restoration projects. From the first estimate through final walkthrough, we work with integrity and keep your goals at the center of every decision.",
    imageSrc: stoneSampleContentImage,
    imageAlt: "Stone Pillar Contractors crew at work on a construction project",
  },
  row2: {
    title: "Residential Construction",
    body:
      "Your home deserves work that is planned well and built to last. Stone Pillar Contractors handles renovations, remodels, carpentry, concrete, and full-scale residential projects with attention to detail at every stage. We keep you informed, answer questions honestly, and deliver finished spaces you can be proud of for years to come.",
    imageSrc: stoneSampleContentImage,
    imageAlt: "Residential construction and remodeling by Stone Pillar Contractors",
  },
  row3: {
    title: "Restoration Services",
    body:
      "When your property needs repair or rebuilding, you need a team that responds with skill and care. Stone Pillar Contractors helps restore damaged structures, address structural concerns, and bring residential and commercial spaces back to solid condition with quality materials and proven methods.",
    get phoneLabel() {
      return stonePillarPhone();
    },
    get phoneHref() {
      return phoneTelHref(stonePillarPhone());
    },
    imageSrc: stoneSampleContentImage,
    imageAlt: "Restoration and repair work by Stone Pillar Contractors",
  },
};

/** Stone Pillar Contractors — Image(s) v1 (horizontal gallery row). */
export const stonePillarImagesV1Content = {
  heading: "Industry Affiliations",
  seoDescription:
    "Stone Pillar Contractors is affiliated with the Building Industry Association of Washington, BIA of Clark County, and the National Association of Home Builders.",
  cards: [
    {
      id: "images-v1-card-1",
      imageSrc: "/stone/library/biaw-color-logo-300x113.png.webp",
      imageAlt: "Building Industry Association of Washington (BIAW) member logo",
      linkHref: "https://www.biaw.com/join-locally",
      linkTarget: "_blank" as const,
    },
    {
      id: "images-v1-card-2",
      imageSrc: "/stone/library/bia-logo-300x169.webp",
      imageAlt: "Building Industry Association of Clark County member logo",
      linkHref: "https://biaofclarkcounty.org/",
      linkTarget: "_blank" as const,
    },
    {
      id: "images-v1-card-3",
      imageSrc: "/stone/library/nahb-logo-color-300x210.png.webp",
      imageAlt: "National Association of Home Builders (NAHB) member logo",
      linkHref: "https://www.nahb.org/",
      linkTarget: "_blank" as const,
    },
  ],
};
