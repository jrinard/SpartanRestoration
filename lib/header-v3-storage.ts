...
function isHeaderV2MobileLogoAlign(value: unknown): value is HeaderV2MobileLogoAlign {
...
export function normalizeHeaderV3PreviewSettings(
  ...
  return {
    ...
    logoMarginTopPx:
      typeof value.logoMarginTopPx === "number"
    ...
    headerV2NavVisible:
      typeof value.headerV2NavVisible === "boolean"
        ? value.headerV2NavVisible
        : defaultHeaderV3PreviewSettings.headerV2NavVisible,
    headerV2UseGradientBackground:
      typeof value.headerV2UseGradientBackground === "boolean"
        ? value.headerV2UseGradientBackground
        : defaultHeaderV3PreviewSettings.headerV2UseGradientBackground,
    headerV2BackgroundColor: isColor(value.headerV2BackgroundColor)
      ? formatButtonBackgroundColor(parseButtonBackgroundColor(value.headerV2BackgroundColor))
      : defaultHeaderV3PreviewSettings.headerV2BackgroundColor,
    headerV2BackgroundImageSrc:
      typeof value.headerV2BackgroundImageSrc === "string"
        ? value.headerV2BackgroundImageSrc.trim()
        : defaultHeaderV3PreviewSettings.headerV2BackgroundImageSrc,
    headerV2MobileLogoAlign: isHeaderV2MobileLogoAlign(value.headerV2MobileLogoAlign)
      ? value.headerV2MobileLogoAlign
      : defaultHeaderV3PreviewSettings.headerV2MobileLogoAlign,
  };
}
...
export function loadHeaderV3PreviewSettings(): HeaderV3PreviewSettings {
  ...
  try {
    const stored = orgStorageGet(headerV3NavGradientStorageKey);
...
export function saveHeaderV3PreviewSettings(settings: HeaderV3PreviewSettings): void {
  ...
  orgStorageSet(headerV3NavGradientStorageKey, JSON.stringify(settings));
}
