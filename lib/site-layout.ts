...
/** Contained column without horizontal padding — pairs with `siteContainedPaddingClass` on inner content. */
export function getSiteContainedShellClassName(): string {
