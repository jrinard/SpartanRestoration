...
export function normalizeTextIconsV3PreviewSettings(
  ...
  return {
    ...
    contentHeading: normalizeOptionalString(value.contentHeading),
    contentSubheading: normalizeOptionalString(value.contentSubheading),
    itemTitles: normalizeServiceLabelsMap(value.itemTitles),
    itemDescriptions: normalizeServiceLabelsMap(value.itemDescriptions),
    backgroundImageSrc:
...
export function loadTextIconsV3PreviewSettings(): TextIconsV3PreviewSettings {
  ...
  try {
    const stored = orgStorageGet(textIconsV3PreviewStorageKey);
...
export function saveTextIconsV3PreviewSettings(settings: TextIconsV3PreviewSettings): void {
  ...
  orgStorageSet(textIconsV3PreviewStorageKey, JSON.stringify(settings));
}
